...
import { Avatar, Image, Button, Modal, Input, message, Tooltip } from "antd";
import {
  HeartOutlined,
  CommentOutlined,
  DeleteOutlined,
...
const MomentItem = props => {
  ...
  return (
    <div className="outer-item-container">
      <div className="moment-item-container">
