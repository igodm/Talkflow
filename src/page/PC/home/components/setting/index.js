  ...
  return (
    <>
      <div className="setting-field">
        <div className="avatar-setting-block">
          <div className="setting-title">更换头像</div>
        ...
        <div className="nickname-setting-block">
          <div className="setting-title">换个昵称</div>
        ...
        <div className="sign-setting-block">
          <div className="setting-title">换个签名</div>
